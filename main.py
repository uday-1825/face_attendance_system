...
def save_pass():
    ...
    # No password needed, so we simply save without any password check
    txf = open("TrainingImageLabel\psd.txt", "w")
    txf.write('')
    mess._show(title='Password Removed', message='Password removed successfully!!')
    master.destroy()
###################################################################################
...
def psw():
    # No password needed, so directly call the function
    TrainImages()
